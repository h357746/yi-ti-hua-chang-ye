    ...
    var t = t || function(t, r) {
        var e = {},
            ...
            n = i.Base = function() {
                function t() {}
                return {
                    extend: function(r) { t.prototype = this; var e = new t; return r && e.mixIn(r), e.hasOwnProperty("init") || (e.init = function() { e.$super.init.apply(this, arguments) }), e.init.prototype = e, e.$super = this, e },
            ...
            a = s.Hex = {
                ...
                parse: function(t) { for (var r = t.length, e = [], i = 0; i < r; i += 2) e[i >>> 3] |= parseInt(t.substr(i, 2), 16) << 24 - i % 8 * 4; return new o.init(e, r / 2) }
            },
            c = s.Latin1 = {
                stringify: function(t) {
                    for (var r = t.words, e = t.sigBytes, i = [], n = 0; n < e; n++) {
                ...
                parse: function(t) { for (var r = t.length, e = [], i = 0; i < r; i++) e[i >>> 2] |= (255 & t.charCodeAt(i)) << 24 - i % 4 * 8; return new o.init(e, r) }
            },
            h = s.Utf8 = { stringify: function(t) { try { return decodeURIComponent(escape(c.stringify(t))) } catch (t) { throw new Error("Malformed UTF-8 data") } }, parse: function(t) { return c.parse(unescape(encodeURIComponent(t))) } },
            l = i.BufferedBlockAlgorithm = n.extend({
                reset: function() { this._data = new o.init, this._nDataBytes = 0 },
                _append: function(t) { "string" == typeof t && (t = h.parse(t)), this._data.concat(t), this._nDataBytes += t.sigBytes },
                _process: function(r) {
                    var e = this._data,
                        i = e.words,
                        n = e.sigBytes,
                    ...
                    var h = c * s,
                        l = t.min(4 * h, n);
                    if (h) {
                        for (var f = 0; f < h; f += s) this._doProcessBlock(i, f);
                        var u = i.splice(0, h);
                        e.sigBytes -= l
                    }
                    return new o.init(u, l)
                },
                clone: function() { var t = n.clone.call(this); return t._data = this._data.clone(), t },
                _minBufferSize: 0
            }),
            f = (i.Hasher = l.extend({ cfg: n.extend(), init: function(t) { this.cfg = this.cfg.extend(t), this.reset() }, reset: function() { l.reset.call(this), this._doReset() }, update: function(t) { return this._append(t), this._process(), this }, finalize: function(t) { t && this._append(t); var r = this._doFinalize(); return r }, blockSize: 16, _createHelper: function(t) { return function(r, e) { return new t.init(e).finalize(r) } }, _createHmacHelper: function(t) { return function(r, e) { return new f.HMAC.init(t, e).finalize(r) } } }), e.algo = {});
        return e
    }(Math);
    return function() {
            var r = t,
            ...
            n.Base64 = {
                ...
                parse: function(t) {
                    ...
                    for (var s = [], a = 0, c = 0; c < r; c++)
                        if (c % 4) {
                            var h = e.indexOf(t.charAt(c - 1)) << c % 4 * 2,
                                l = e.indexOf(t.charAt(c)) >>> 6 - c % 4 * 2;
                            s[a >>> 2] |= (h | l) << 24 - a % 4 * 8, a++
                        }
                    return i.create(s, a)
                },
                    ...
                    _doProcessBlock: function(t, r) {
                        for (var e = this._hash.words, i = e[0], n = e[1], o = e[2], s = e[3], a = e[4], l = e[5], f = e[6], u = e[7], d = 0; d < 64; d++) {
                            ...
                            var g = a & l ^ ~a & f,
                                ...
                                S = u + k + g + c[d] + h[d],
                                x = w + B;
                            u = f, f = l, l = a, a = s + S | 0, s = o, o = n, n = i, i = S + x | 0
                        }
            ...
            var c = t,
                ...
                B = u.RIPEMD160 = f.extend({
                    ...
                    _doProcessBlock: function(t, r) {
                        ...
                        var f, u, B, w, k, S, x, m, b, H, z = this._hash.words,
                            A = y.words,
                            C = g.words,
                            D = d.words,
                            E = v.words,
                            R = p.words,
                            M = _.words;
                        S = f = z[0], x = u = z[1], m = B = z[2], b = w = z[3], H = k = z[4];
                        for (var F, c = 0; c < 80; c += 1) F = f + t[r + D[c]] | 0, F += c < 16 ? e(u, B, w) + A[0] : c < 32 ? i(u, B, w) + A[1] : c < 48 ? n(u, B, w) + A[2] : c < 64 ? o(u, B, w) + A[3] : s(u, B, w) + A[4], F |= 0, F = a(F, R[c]), F = F + k | 0, f = k, k = w, w = a(B, 10), B = u, u = F, F = S + t[r + E[c]] | 0, F += c < 16 ? s(x, m, b) + C[0] : c < 32 ? o(x, m, b) + C[1] : c < 48 ? n(x, m, b) + C[2] : c < 64 ? i(x, m, b) + C[3] : e(x, m, b) + C[4], F |= 0, F = a(F, M[c]), F = F + H | 0, S = H, H = b, b = a(m, 10), m = x, x = F;
                        F = z[1] + B + b | 0, z[1] = z[2] + w + H | 0, z[2] = z[3] + k + S | 0, z[3] = z[4] + f + x | 0, z[4] = z[0] + u + m | 0, z[0] = F
                    },
                    _doFinalize: function() {
                        var t = this._data,
                            r = t.words,
                    ...
                    for (var c = 0; c < 24; c++) {
                        ...
                        for (var S = 1; S < 25; S++) {
                            var a = e[S],
                                ...
                                m = a.low,
                                b = h[S];
                            if (b < 32) var v = x << b | m >>> 32 - b,
                                p = m << b | x >>> 32 - b;
                            else var v = m << b - 32 | x >>> 64 - b,
                                p = x << b - 32 | m >>> 64 - b;
                            var H = u[l[S]];
                            H.high = v, H.low = p
                        }
        ...
        function() {
            ...
            var f = c.SHA512 = n.extend({
                ...
                _doProcessBlock: function(t, r) {
                    for (var e = this._hash.words, i = e[0], n = e[1], o = e[2], s = e[3], a = e[4], c = e[5], f = e[6], u = e[7], d = i.high, v = i.low, p = n.high, _ = n.low, y = o.high, g = o.low, B = s.high, w = s.low, k = a.high, S = a.low, x = c.high, m = c.low, b = f.high, H = f.low, z = u.high, A = u.low, C = d, D = v, E = p, R = _, M = y, F = g, P = B, W = w, O = k, U = S, I = x, K = m, X = b, L = H, j = z, N = A, T = 0; T < 80; T++) {
                        var Z = l[T];
                        ...
                        var ft = O & I ^ ~O & X,
                            ...
                            kt = Bt.low,
                            St = N + gt,
                            xt = j + yt + (St >>> 0 < N >>> 0 ? 1 : 0),
                            St = St + ut,
                            xt = xt + ft + (St >>> 0 < ut >>> 0 ? 1 : 0),
                            St = St + kt,
                            xt = xt + wt + (St >>> 0 < kt >>> 0 ? 1 : 0),
                            St = St + G,
                            xt = xt + q + (St >>> 0 < G >>> 0 ? 1 : 0),
                            mt = _t + vt,
                            bt = pt + dt + (mt >>> 0 < _t >>> 0 ? 1 : 0);
                        j = X, N = L, X = I, L = K, I = O, K = U, U = W + St | 0, O = P + xt + (U >>> 0 < W >>> 0 ? 1 : 0) | 0, P = M, W = F, M = E, F = R, E = C, R = D, D = St + mt | 0, C = xt + bt + (D >>> 0 < St >>> 0 ? 1 : 0) | 0
                    }
                    v = i.low = v + D, i.high = d + C + (v >>> 0 < D >>> 0 ? 1 : 0), _ = n.low = _ + R, n.high = p + E + (_ >>> 0 < R >>> 0 ? 1 : 0), g = o.low = g + F, o.high = y + M + (g >>> 0 < F >>> 0 ? 1 : 0), w = s.low = w + W, s.high = B + P + (w >>> 0 < W >>> 0 ? 1 : 0), S = a.low = S + U, a.high = k + O + (S >>> 0 < U >>> 0 ? 1 : 0), m = c.low = m + K, c.high = x + I + (m >>> 0 < K >>> 0 ? 1 : 0), H = f.low = H + L, f.high = b + X + (H >>> 0 < L >>> 0 ? 1 : 0), A = u.low = A + N, u.high = z + j + (A >>> 0 < N >>> 0 ? 1 : 0)
                },
                _doFinalize: function() {
                    var t = this._data,
                        r = t.words,
            ...
            var e = t,
                ...
                f = i.Cipher = s.extend({
                    ...
                    _createHelper: function() {
                        function t(t) { return "string" == typeof t ? x : w }
        ...
        function() {
            ...
            var p = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                _ = n.AES = i.extend({
                    _doReset: function() {
                        for (var t = this._key, r = t.words, e = t.sigBytes / 4, i = this._nRounds = e + 6, n = 4 * (i + 1), s = this._keySchedule = [], a = 0; a < n; a++)
                            if (a < e) s[a] = r[a];
                            else {
                                var c = s[a - 1];
